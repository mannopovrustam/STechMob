<div class="popup__add width__25 {{ $addDiscount }}" xmlns:wire="http://www.w3.org/1999/xhtml">
    <div class="card" xmlns:wire="http://www.w3.org/1999/xhtml">
        <div class="card-header bg-transparent border-bottom py-3 px-4">
            ...
            <a href="javascript:void(0);" wire:click="$set('addDiscount', 'false')" class="ms-auto">
        ...
        <div class="card-body p-4">
            <div class="mb-3">
                <div class="d-flex justify-content-between align-items-end">
                    <input class="form-control" type="text" id="discount" wire:model="discountValue" placeholder="Chegirma kiriting">
                    <div class="btn-group" style="margin-left: 1rem;" role="group"
                         aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" name="btnradio" wire:model="discountType" value="percentage" @checked($discountType == 'percentage') id="btnradio1">
                        <label class="btn btn-light mb-0" for="btnradio1">%</label>

                        <input type="radio" class="btn-check" name="btnradio" wire:model="discountType" value="money" @checked($discountType == 'money') id="btnradio2">
